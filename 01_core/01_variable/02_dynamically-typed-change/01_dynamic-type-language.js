/* 정적타입(static / strong type)
   ...
   동적타입(dinamic / weak type)
    ...
    - 변수의 값이 언제든지 변경될 수 있기 때문에 값을 확인하기 전까지
      데이터 타입을 확실할 수 없다.
    - 개발자의 의도와 다르게 자바스크립트 엔진에 의해 타입이 변경될 수 있기
      때문에 값의 불확실성이 크다.
    ...
    // 이런식으로 자바스크립트 언어는 동적으로 언어를 할당함에 따라
    // 데이터 타입이 변하게 된다.
