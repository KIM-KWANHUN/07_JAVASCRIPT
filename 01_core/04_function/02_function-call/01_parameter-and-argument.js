...
function hello(name){
    // 마찬가지로 매개변수는 해당 함수 {} 에서만 사용 가능하다.
    
    // 모든 전달인자들은 암묵적으로 auguments 객체의 프로퍼티로 보관
...
function hi(name = '기본값') {
    ...
    console.log('인수는 1개 이어야 하며, 문자열 값이고, 빈문자열을 허용하지 않습니다.')
