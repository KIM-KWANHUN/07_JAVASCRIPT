...
// true 와 fasle 반환 (includes)
console.log(`includes(인자) : ${foodList.includes('물회')}`);
console.log(`includes(없는요소) : ${foodList.includes('삼겹살')}`);
console.log('=======================================================');
// 기준 배열
const chineseFood = ['짜장', '짬뽕', '탕수육'];
// unshift : 배열의 맨 앞에 요소 추가
// shift : 배열의 맨앞 요소 제거 후 반환
...
console.log('=======================================================');
// 두 개 이상의 배열을 결합
const idol = ['비투비', '아이브', '블랭핑크'];
const idol2 = ['소녀시대', '원더걸스', '에스파'];
...
console.log(`slice(1, 3) : ${backend.slice(1, 3)}`); // 3미만 까지 출력
// 반환만 해주는 것이고, 요소를 삭제하는 것은 아님
console.log(backend);
// (index, 제거 수, 추가할 값1, 추가할 값 2 ...)
